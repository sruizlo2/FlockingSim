...
% Load file with data 
% filename = 'Murmuration_FEConvergence2_Reference.mat'; % Original parms
filename = 'Murmuration_FEConvergence3_Reference.mat'; % Modified parms
...
nFig = 3;
figure2(nFig), subplot(221), loglog(10 .^ -(2:nMax), refConf(2:nMax), 'k.', 'markersize', 20),
grid on, grid minor,
