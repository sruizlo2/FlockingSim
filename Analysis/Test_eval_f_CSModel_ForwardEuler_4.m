...
outputFolder = '../Output/FEConvergenceNoAM';
[~, ~, ~] = mkdir(outputFolder);
...
parms.Ka = 0.0;       % Interaction strength of acceleration matching
...
filenameSufix = 'FEConvergence2_n5';
...
FEparms.progstep = 1;    % Percentange of progress of FE to show
