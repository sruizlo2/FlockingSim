...
outputFolder = '../Output/FEConvergencewAM-v2-del';
[~, ~, ~] = mkdir(outputFolder);
...
filenameSufix = 'FEConvergence_p1';
...
FEparms.keepHist = true;  % Keep history or only last solution and output?
FEparms.visualize = 100;  % Number of figure to visualize plot (false for not plotting)
FEparms.verbsoity = true; % Print progress of FE?
parms.progstep = 1;       % Percentange of progress of FE to show
nVect = 2;              % Vector with n's that define the time steps 10^(-n)
